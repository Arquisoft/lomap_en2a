...
test('check that the location list renders propertly',async () => {
    const {getByText}= render(<ListOfLocations setSelectedLocation={jest.fn()} loadLocations={jest.fn()} places={testLocations} setSelectedView={()=>{}}></ListOfLocations>)
...
test('check that with no location the loading squeletons appear',async () => {
    const {getByTestId}= render(<ListOfLocations setSelectedLocation={jest.fn()} loadLocations={jest.fn()} places={[]} setSelectedView={()=>{}}></ListOfLocations>)
